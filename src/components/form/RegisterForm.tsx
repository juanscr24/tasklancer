...
export const RegisterForm = () => {
    ...
    const onSubmit = async (data: RegisterFormData) => {
        try {
            ...
            setSuccessMessage(undefined); // Reset previous success message
            ...
            startTransition(async () => {
                ...
                if (response.error) {
                    ...
                    // Mostrar mensaje de éxito - el usuario debe verificar su email
        ...
        <form
            ...
            {verified && (
                <div className="p-3 text-sm text-green-600 bg-green-100 border border-green-200 rounded-md w-full mb-2">
                    {tAuth('emailVerifiedSuccessfully')}
                </div>
            )}
            ...
            {successMessage && (
                <div className="p-3 text-sm text-green-600 bg-green-100 border border-green-200 rounded-md w-full">
                    {successMessage}
                </div>
            )}
