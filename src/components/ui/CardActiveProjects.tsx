export const CardActiveProjects = ({ projects }) => {
    return (
        <div className="flex flex-row justify-between gap-6 w-full bg-(--bg-2) rounded-xl shadow-lg p-6 text-(--text-1) h-full border border-(--border-1)">
            ...
            {projects.map((project, i) => {
                ...
                return (
                    <div key={i} className="flex-1 bg-(--bg-3) rounded-xl p-6 shadow-lg  hover:scale-102 transition-all duration-300">
